<template>
  <div class="m10">
    <el-row :gutter="10">
      <el-col :span="6" v-for="item in growCardData" :key="item.id">
        <Card :card-name="item.title">
...
export default defineComponent({
  components: {Card,LineChart,BarChart,ScatterChart,PieChart,AccessSales,BottomContain},
  setup(){
    return {
      growCardData
    }
